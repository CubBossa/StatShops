...
public class ItemStackCurrency extends Currency<ItemStack> {

	public ItemStackCurrency() {
		this("<yellow><amount>x <gold><currency>");
	}

	public ItemStackCurrency(String format) {
		super(format, true, (integer, itemStack) -> Component.translatable("item.minecraft." + itemStack.getType().toString().toLowerCase()));
	}
